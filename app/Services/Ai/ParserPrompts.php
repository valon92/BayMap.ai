...
- travel/flights: "bilet avioni nga Geneva ne London 21.06.2026" => category travel, product_type flight, origin_city Geneva, destination_city London, departure_date YYYY-MM-DD, travel_type one_way, travelers 1. Albanian: "bilet udhetimi per daten 10 korrik nga londra ne berlin" => departure_date 2026-07-10, origin_city London, destination_city Berlin. Months: janar, shkurt, mars, prill, maj, qershor, korrik, gusht, shtator, tetor, nentor, dhjetor. Do NOT set year, year_min, year_max, or gender for travel. Route cities are not search countries — leave search_country null unless buyer names where to book.
